...
class MasseFrame(wx.Frame):
    ...
    def create_main_panel(self, df, fn, fsize=1.0, size=1.0):
        ...
        self.PPMtranLHOn.Bind(wx.EVT_CHECKBOX, self.on_PPMtranLHOn)
        self.PPMtranTRANALLOn.Bind(wx.EVT_CHECKBOX, self.on_PPMtranTRANALLOn)
        self.PPMdsLOn.Bind(wx.EVT_CHECKBOX, self.on_PPMdsLOn)
        self.PPMdsHOn.Bind(wx.EVT_CHECKBOX, self.on_PPMdsHOn)
        self.RTdsLHOn.Bind(wx.EVT_CHECKBOX, self.on_RTdsLHOn)
        self.RTdsTRANALLOn.Bind(wx.EVT_CHECKBOX, self.on_RTdsTRANALLOn)
        self.RTpepTRANALLOn.Bind(wx.EVT_CHECKBOX, self.on_RTpepTRANALLOn)
        ...
        self.priorFilterOn.Bind(wx.EVT_CHECKBOX, self.on_priorFilterOn)
        self.idpOn.Bind(wx.EVT_CHECKBOX, self.on_idpOn)
    ...
    def on_PPMtranLHOn(self, event):
        self.recalcAndDrawAll()
    def on_PPMtranTRANALLOn(self, event):
        self.recalcAndDrawAll()
    def on_PPMdsLOn(self, event):
        self.recalcAndDrawAll()
    def on_PPMdsHOn(self, event):
        self.recalcAndDrawAll()
    def on_RTdsLHOn(self, event):
        self.recalcAndDrawAll()
    def on_RTdsTRANALLOn(self, event):
        self.recalcAndDrawAll()
    def on_RTpepTRANALLOn(self, event):
        self.recalcAndDrawAll()
    ...
    def on_handDeleteOn(self, event):
        self.recalcAndDrawAll()
    def on_priorFilterOn(self, event):
        self.recalcAndDrawAll()
    def on_idpOn(self, event):
        self.recalcAndDrawAll()
    def on_ldpOn(self, event):
        self.recalcAndDrawAll()
